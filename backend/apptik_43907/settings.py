"""
Django settings for apptik_43907 project.
...
ROOT_URLCONF = 'apptik_43907.urls'
...
WSGI_APPLICATION = 'apptik_43907.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "apptik_43907 API",
    "DESCRIPTION": "API documentation for apptik_43907 App",
    "VERSION": "v1",
}
